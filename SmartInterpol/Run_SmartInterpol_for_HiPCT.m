...
SmartInterpol(im_vol,lab_vol , result_path, trained_net_file, 'downsampling_factor', downsampling_factor,'LF_downsampling_factor',LF_downsampling_factor,'LUT_path',LUT_fullPath,'maxepoch_global',3000,'LR_global',0.1,'lambda_DL',2,'minibatch_global',4,'LR_local',0.1,'minibatch_local',4,'firstSliceOption',1,'lastSliceOption',1)
